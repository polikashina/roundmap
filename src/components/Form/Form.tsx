...
import { getModeTitle, isEditableMode } from "../../Store/Mode/Selectors";
import { ActionTypes } from "../../Store/Area/Reducer";
import { getValidationError, getCurrentItem, getSelectedItemId } from "../../Store/Area/Selectors";
...
const mapStateToProps = (state: State): StateProps => {
    return {
        isEdit: isEditableMode(state),
        currentItem: getCurrentItem(state),
        selectedItemId: getSelectedItemId(state),
        modeTitle: getModeTitle(state),
